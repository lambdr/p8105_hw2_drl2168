...
extra columns that get read in, and I remove both of them.
...
or `sports_balls`. While Mr. and Professor Trash Wheels containt the
variable `grocery_bags`, Gwynnda contains the variable `plastic_bag`. I
renamed this for consistencies of variable names.
...
study, 479 eligable subjects were recruited, of which 93 developed MCI
...
observations for each of the 471 subjects.
