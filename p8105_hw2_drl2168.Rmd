...
The final `df_ad` dataframe contains `r nrow(df_ad)` observations of `r ncol(df_ad)` variables, 5 observations for each of the `r length(unique(pull(df_ad, id)))` subjects.
