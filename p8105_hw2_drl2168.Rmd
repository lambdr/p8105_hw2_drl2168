...
The `df_tw` dataframe contains `r nrow(df_tw)` observations of `r ncol(df_tw)` variables for `r length(unique(pull(df_tw, wheel)))` different trash wheels.

sum of trash weight for prof
sum of cig butts for gwyn in july 2021
