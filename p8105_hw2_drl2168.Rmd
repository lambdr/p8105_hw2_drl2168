...
I then read in the Professor and Gwynnda Trash Wheel data, noting that `df_prof_tw` does not have the variable `sports_balls` and that `df_gwyn_tw` does not have the variables `glass_bottles`, `chip_bags`, or `sports_balls`. While Mr. and Professor Trash Wheels contain the variable `grocery_bags`, Gwynnda contains the variable `plastic_bag`. I renamed this for consistency of variable names.
